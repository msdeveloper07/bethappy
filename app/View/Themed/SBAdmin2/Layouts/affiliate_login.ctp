                                ...
                                <div class="col-lg-6 bg-login-form">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <img class="text-center mb-3" src="img/casino/atlantic_slot_logo.png" height="120"/>

                                            <h1 class="h4 mb-4">Welcome to <?php echo Configure::read('Settings.websiteName'); ?> Affiliate Panel!</h1>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <?php echo $this->Form->input('password', array('id' => 'UserPassword', 'class' => "form-control form-control-sm", 'placeholder' => 'Password', 'label' => false, 'div' => false)); ?>                                            
                                        </div>
                                        <!--LAYOUT-->
                                        <div class="form-group hidden">
                                            <?= $this->Form->input('group_id', array('type' => 'select', 'options' => $groups, 'default'=>9, 'class' => 'form-control form-control-sm', 'div' => false, 'label' => false, 'disabled'=>true)); ?>
                                        </div>
                                        <!--                                        <div class="form-group">
