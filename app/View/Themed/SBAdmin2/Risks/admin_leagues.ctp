<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12"><?= $this->element('breadcrumbs', array('data' => $this->Breadcrumb->buildFromURI(array(0 => '', 1 => __($pluralName), 2 => __('List Leagues'))))); ?></div>
    </div>
            ...
            <div class="span12">
                ...
                <?php foreach ($data as $key => $country): ?>
                    <div class="widget tradedwidget">
                        ...
                        <div class="widget-body bodyevent_<?=$key;?> tradedwidget" style="display: none">
                            <div class="row-fluid">
                                <div class="span12">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($country['Leagues'] as $row): ?>
                                                            <tr>
                                                                ...
                                                                <td><a class="adjust-limit btn btn-mini btn-primary" data-type="League" data-key='<?= $row['League']['id'] ;?>'><i class="icon-save" style="margin-right:5px;"></i><?=__('Save');?></a></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    </tbody>
                                                </table>
