        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?= __('Mistery Mini'); ?></li>
                </ol>
            </nav>

            <div class="d-flex justify-content-between">
                <h1 class="h3 mb-1 text-gray-800"><?= __('Mistery Midi'); ?></h1>
            </div>
            <br>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive-sm pt-2">
                    ...
                    <ul>
                        <li><?= __('single deposit >= 150'); ?></li>
                        <li><?= __('cumulative deposits >= 1500'); ?></li>
