...
<?php if ($pay_providers): ?>
    <div class="">
        <label class="control-label"><?= __('Providers'); ?></label>
        <div class="controls">
            <div class="input-append">
                <select type="select" name="data[<?= $model; ?>][pay_provider]">
                    <option selected disabled><?php echo __('Select provider'); ?></option>
                    <?php foreach ($pay_providers as $key => $provider) { ?>
...
<?php if (!empty($game_providers)): ?>
    <div class="">
        ...
        <div class="controls">
            <div class="input-append">
                <select type="select" name="data[<?= $model; ?>][game_provider]">
                    <option selected disabled><?php echo __('Select provider'); ?></option>
