                        ...
                        <div class="col-md-12">
                            <div class="card card-gradient">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><i class="icon ion-ios-swap mr-2"></i><?= __('Casino transactions'); ?></span>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="card card-outline px-4 py-2">
                                                <p><?= __('Bets'); ?> ({{casinoSummary.count.bets}})</p>
                                                <h4>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="card card-outline px-4 py-2">
                                                <p><?= __('Wins'); ?> ({{casinoSummary.count.wins}})</p>
                                                <h4>                                    
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="card card-outline px-4 py-2">
                                                <p><?= __('Refunds'); ?> ({{casinoSummary.count.refunds}})</p>
                                                <h4>                                    
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3">
                                            <div class="card card-outline px-4 py-2">
                                                <p><?= __('Rollbacks'); ?> ({{casinoSummary.count.rollbacks}})</p>
                                                <h4>
                                    ...
                                    <ul class="account-list">
                                        ...
                                        <li ng-if="casinoTransactions.length == 0"><?= __('No transactions yet.'); ?></li>
                                    </ul>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="card card-gradient">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><i class="icon ion-ios-swap mr-2"></i><?= __('Bonus transactions'); ?></span>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-gradient">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span><i class="icon ion-ios-swap mr-2"></i><?= __('Games played'); ?></span>
                                ...
                                <div class="card-body">
                                    <ul class="games-list">
                                        ...
                                        <li ng-if="gamesLogs.length == 0"><?= __('No games played yet.'); ?></li>
                                    </ul>
