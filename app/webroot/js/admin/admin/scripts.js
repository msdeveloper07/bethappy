var App = function () {
    ...
    var handleChat = function () {
        ...
        var handleClick = function () {
            ...
            var tpl = '';
            tpl += '<li class="out">';
            tpl += '<img class="avatar" alt="" src="/img/admin/avatar1.jpg"/>';
    ...
    var handleWidgetTools = function () {
		...
		jQuery('.widget .tools .icon-chevron-down, .widget .tools .icon-chevron-up').each(function(){
            console.log('clicked!');
            $(this).on("click", function(){
                var el = jQuery(this).parents(".widget").children(".bodyevent_"+ $(this).attr("data-id"));
        ...
        $(document).on("click", '.icon-chevron-down, .icon-chevron-up', function(){ 
			console.log('second');
            var el = jQuery(this).parents(".widget").children(".bodyevent_"+ $(this).attr("data-id"));
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "/css/admin/style_" + color + ".css");
        }
    ...
    var handleGritterNotifications = function () {
        ...
        $('#gritter-sticky').click(function () {
            var unique_id = $.gritter.add({
                ...
                image: '/img/admin/avatar-mini.png',
...
//                handleIntro();
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="/img/admin/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
...
$(document).ready(function() {
    $(document.body).on('click', '.popup-btn', function(e) {
        e.stopPropagation();
        
        var _this = this;
        
        $('#popup').width((parseInt($(window).width()) * 0.5));
        $('#popup').css('left', '40%');
        $('#popup').height((parseInt($(window).height()) * 0.6));
        
        $('#popup').on('show', function () {
            $('#popup').html('<iframe src="' + $(_this).data('popup') + '" style="zoom:0.60" width="99.6%" height="99%" frameborder="0"></iframe>');
            
            $("#popup iframe").load(function(){
                var url = $("#popup iframe").get(0).contentWindow.location.href;
