...
app.controller('appController', function ($rootScope, $scope, $sce, $window, $location, $routeParams, $filter, $timeout, $interval, $http, $uibModal, SweetAlert, WizardHandler, appSettings, usersService, countriesService, currenciesService, gamesService) {
...
//            size: 'xl',
    ...
    $scope.openSignInModal = function (task) {        
        modalSignUp = $uibModal.open({
            animation: false,
            templateUrl: 'casino-angularjs/views/partials/sign-in.html',
            controller: 'modalController',
            scope: $scope,
            size: 'md',
            backdrop: 'static'
...
//    $scope.disableSignUpStep1 = true;
    ...
    $scope.signOut = function () {
        usersService.signOut().then(function (response) {
            ...
            $window.location.href = 'https://www.atlanticslot.com/';
            $window.location.reload();
        });
    }
