...
<wsdl:definitions xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://GMS.Integration.Plugin/Callback" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" targetNamespace="http://GMS.Integration.Plugin/Callback">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://GMS.Integration.Plugin/Callback">
  ...
  <wsdl:portType name="CallbackSoap">
  ...
  <wsdl:binding name="CallbackSoap" type="tns:CallbackSoap">
    <soap:binding transport="http://schemas.xmlsoap.org/soap/http"/>
    <wsdl:operation name="Deposit">
      <soap:operation soapAction="http://GMS.Integration.Plugin/Callback/Deposit" style="document"/>
      <wsdl:input>
    ...
    <wsdl:operation name="Withdraw">
      <soap:operation soapAction="http://GMS.Integration.Plugin/Callback/Withdraw" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetBalance">
      <soap:operation soapAction="http://GMS.Integration.Plugin/Callback/GetBalance" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="RollbackTransaction">
      <soap:operation soapAction="http://GMS.Integration.Plugin/Callback/RollbackTransaction" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="CallbackSoap12" type="tns:CallbackSoap">
    <soap12:binding transport="http://schemas.xmlsoap.org/soap/http"/>
    <wsdl:operation name="Deposit">
      <soap12:operation soapAction="http://GMS.Integration.Plugin/Callback/Deposit" style="document"/>
      <wsdl:input>
    ...
    <wsdl:operation name="Withdraw">
      <soap12:operation soapAction="http://GMS.Integration.Plugin/Callback/Withdraw" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="GetBalance">
      <soap12:operation soapAction="http://GMS.Integration.Plugin/Callback/GetBalance" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="RollbackTransaction">
      <soap12:operation soapAction="http://GMS.Integration.Plugin/Callback/RollbackTransaction" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:port name="CallbackSoap" binding="tns:CallbackSoap">
      <soap:address location="http://82.214.112.218/tomhorn/TomhornWallet/" />
    </wsdl:port>
    <wsdl:port name="CallbackSoap12" binding="tns:CallbackSoap12">
      <soap12:address location="http://82.214.112.218/tomhorn/TomhornWallet/" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>