<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between">
                <h1 class="h3 mb-1 text-gray-800"><?= __('Deposits'); ?></h1>
            </div>
            <br>
        </div>
    </div>
    ...
    <div id="page" class="dashboard">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <?= __('Please choose your timeframe and provider, otherwise the report will show data for the current month for all providers.'); ?><br/><br/>
                <?= $this->element('reports_form', array('payment_providers' => $payment_providers)); ?><br/>
...
<!--                                    <tr>
                                    ...
                                    <?php endforeach; ?>
                                      <?php if (!empty($selected_status) || !empty($selected_provider)): ?>
                                        <tr>
                                            <td colspan="3" style="text-align: right; background-color:#f9f9f9;"><b><?= __('TOTAL'); ?>:</b></td>
