        ...
        <div class="row">  
            <div class="col-md-12">
                ...
                <div class="card default-payment-card">
                    ...
                    <div class="card-body">
                        <p>For Bank transfer please contact us on <a href="mailto:support@atlanticslot.com">support@atlanticslot.com</a></p>
<!--                        <p>Please submit your bank details below.</p>
                        <p>You will receive instructions on your mail how to transfer the money with bank transfer.</p>
                        <p>After we confirm the payment, the amount will be transfered on your account.</p>
                        ...
                        <div class="form-group submit-group text-center mx-auto">
                            <?= $this->MyForm->button(__('Request deposit', true), array('type' => 'submit', 'class' => 'btn btn-default rounded-pill px-4 btn-deposit', 'name' => 'payment', 'value' => 'BT', 'div' => false)); ?> 
                        </div>  
...
<script>
//    $(function () {
//        $('#BankTransferDepositForm').parsley()
