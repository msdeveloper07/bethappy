			...
			<div class="col-12">
				<div class="d-flex align-items-center justify-content-center">
					<div class="d-flex align-items-center">
						...
						<div class="ml-3">
							<span class="deposit-method-name mb-0_25" id="cName">AstroPay</span>
...
<script>
	...
	$("#astropay-form #deposit-succeed").hide();
	$("#astropay-form #deposit-processing").hide();
	$("#astropay-form #deposit-failed").hide();
	...
	function requestDeposit(event) {
		...
		$.ajax({        
			url: `/payments/astropay/deposit/${amount}`,
			type : 'POST',
			data : {
				post: 1
			},
			...
			success : function(data) {   
				...
				if (data.status === 'PENDING') {
					...
					if (data.status === 'APPROVED') {
						$("#astropay-form #deposit-succeed").show();
                        $("#astropay-form #form").hide();

					} else {
						swal("<?=__("Error")?>", data.description, "error");
					}
				}
			...
			error : function(request, error) {
				...
				swal("<?=__("Error")?>", request.responseText, "error");
