<div class="container-fluid">
    ...
    <div id="page" class="dashboard">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <?= __('Please choose your timeframe and/or currency, otherwise the report will show data for the current month for all currencies.'); ?><br/><br/>
                            ...
                            foreach ($data as $currency => $users):
                                if (!empty($currency)):
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th colspan="8" style="background-color: #f9f9f9; text-align:left; color: #858796;"><?= $currency; ?></th>
                                        </tr>
...
<!--                                            <th style="text-align:center;"><?= __('Real'); ?><br/> <?= __('GGR'); ?></th>
                                        ...
                                        foreach ($users as $key => $user):
                                            if (!empty($user['RealTransactions']) || !empty($user['BonusTransactions'])):
                                                ...
                                                //total player
                                                $total_player_real_GGR = round($user['RealTransactions']['real_bets'] - $user['RealTransactions']['real_wins'] + $user['RealTransactions']['real_refunds'] - $user['RealTransactions']['real_rollbacks'], 2);
                                                ...
                                                $total_player_GGR = ($user['RealTransactions']['real_bets'] - $user['RealTransactions']['real_wins'] + $user['RealTransactions']['real_refunds'] - $user['RealTransactions']['real_rollbacks']) + ($user['BonusTransactions']['bonus_bets'] - $user['BonusTransactions']['bonus_wins'] + $user['BonusTransactions']['bonus_refunds'] - $user['BonusTransactions']['bonus_rollbacks']);
...
<!--                                        <tr style="border-top:2px solid #dddfeb;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="background-color: #f9f9f9; text-align: right; "><b><i><?= $currency; ?> <?= __('TOTALS'); ?>:</i></b></td>
