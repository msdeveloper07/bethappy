			...
			$.ajax({
				 ...
				 success:function(xml) {
					...
					if (isMobile()) {
						...
						window.location.replace(htmldirectory + "00Wazdan/loader.html"
													+ "?game=" + gametoload
													+ "&mobile=1"
													+ "&lang=" + lang
													+ "&closeurl=" + closeURL
					...
					$('<iframe>', {
						src: htmldirectory + "00Wazdan/loader.html" 
								+ "?game=" + gametoload
								+ "&mobile=0"
								+ "&lang=" + lang
								+ "&closeurl=" + closeURL
