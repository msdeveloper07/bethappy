                            ...
                            <div class="span12">
                                <div class="table table-custom">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <?= __('Report will show total GGR by currency for games played. Please set your own date filters.'); ?><br><br>
                                                    ...
                                                    foreach ($games as $game) :
                                                        if ($game['RealTransactions']['Bets'] || $game['BonusTransactions']['Bets']) :
                                                            ...
                                                            <tr class="collapseme<?= $currency; ?>">
                                                                <td><?= $game['id']; ?></td>
                                                                <td><?= $game['name']; ?></td>
                                                                <td><?= round(($game['RealTransactions']['Bets']), 2); ?></td> 
                                                                <td><?= round($game['RealTransactions']['Wins'], 2); ?></td> 
                                                                <td><?= round($game['RealTransactions']['Refund'], 2); ?></td> 
                                                                <td><?= round(($game['RealTransactions']['Bets']) - $game['RealTransactions']['Wins'], 2); ?></td> 
                                                                <td><?= round(($game['BonusTransactions']['Bets']), 2); ?></td> 
                                                                <td><?= round($game['BonusTransactions']['Wins'], 2); ?></td> 
                                                                <td><?= round($game['BonusTransactions']['Refund'], 2); ?></td> 
                                                                <td><?= round(($game['BonusTransactions']['Bets']) - $game['BonusTransactions']['Wins'], 2); ?></td> 
                                                                <td><?= round(($game['RealTransactions']['Bets']) - $game['RealTransactions']['Wins'] + ($game['BonusTransactions']['Bets']) - $game['BonusTransactions']['Wins'], 2); ?></td> 
                                                            </tr>
                                                            <?php
                                                        endif;
                                                    endforeach;
