...
<html>
	<head>
		...
		<?php
			...
			echo $this->Html->css('Games.venum.index');
						...
						<?php if ( isset ( $_SESSION['MyPlayerID'] ) ) { ?>	
							...
							<div  class="col-md-4 actionButtons">
								<div class="d-flex justify-content-end">
									<a href="/games/venum/deposit?action=deposit" class="btn btn-primary" id="spaceBetween">Deposit</a>  <a href="/venum/games/cashout?action=cashout" class="btn btn-primary" id="spaceBetween">Cashout</a>  <a href="/venum/games/customcashout?action=customcashout" class="btn btn-primary" id="spaceBetween">Custom Cashout</a> <a href="/venum/games/logout?action=logout" class="btn text-danger" id="spaceBetween"><i class="fa fa-sign-out-alt"></i>Log out</a><br/>
								</div>
							</div>
						<?php } else { ?>
							<div  class="col-md-8">
								<div class="d-flex justify-content-end">
									<a href="/games/venum/login?action=login" class="btn text-primary">
