 ...
 * 
 */
class VenumController extends VenumApiController {
     ...
     * @var array
     */
    public $uses = array('Games.VenumGame', 'User', 'IntGames.IntCategory', 'IntGames.IntBrand');
    public $layout = 'Games.main_layout';
    public $name = 'Venum';
    ...
    public function customcashout() {
        if ($this->request->is('post')) {
            ...
            $this->render('/Venum/cashout');
        }
    }

    public function gameview() {
        $this->layout =  'Games.gameview_layout';
        
        $this->render('/Venum/gameview');
    }

    public function gameview_amatic_mobile() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_amatic_mobile');
    }

    public function gameview_netenthtml() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_netenthtml');
    }

    public function gameview_netent() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_netent');
    }

    public function gameview_egt_mobile() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_egt_mobile');
    }

    public function gameview_egt() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_egt');
    }

    public function gameview_novomatic() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_novomatic');
    }

    public function gameview_wazdan() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_wazdan');
    }

    public function gameview_pragmaticplay() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_pragmaticplay');
    }

    public function gameview_quickspin() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_quickspin');
    }

    public function gameview_quickspinflash() {
        $this->layout =  'Games.gameview_layout';

        $this->render('/Venum/gameview_quickspinflash');
    }
