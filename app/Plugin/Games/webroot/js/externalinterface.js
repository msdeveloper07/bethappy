...
var communicationdirectory = "http://atlanticslot.local/games/venum/";
...
function GetUrlPrefix() {
	...
	if ( spl[ spl.length - 3 ] == "userbytoken" ) return "/games/venum/gameplay?reqfile=game/" + gamemode + "/";
	return "/games/venum/gameplay?reqfile=game/" + gamemode + "/";
}
