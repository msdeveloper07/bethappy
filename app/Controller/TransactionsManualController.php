<?php
/**
 * Handles TransactionsManual
 *
 * Handles TransactionsManual Actions
 *
 * @package    TransactionsManual
 * @author     
 * @copyright  
...
class TransactionsManualController extends AppController {
    
    /**
     * Controller name
     * @var string
     */
    public $name = 'TransactionsManual';
    ...
    /**
     * Shows user TransactionsManual table
     * @return void
     */
    ...
    public function admin_complete($id) {
        ...
        $this->redirect(array('controller' => 'transactionsmanual', 'action' => 'admin_index'));
    }
}